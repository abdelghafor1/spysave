...
export default function AccountPage() {
  ...
  return <main className="aurora-page min-h-screen px-5 py-6 text-[#13231f]">
    <ServiceMenu />
    <section className="mx-auto max-w-4xl pt-16"><p className="app-kicker">Your SpySave profile</p><h1 className="mt-2 text-4xl font-semibold">Account</h1><p className="mt-2 text-sm font-semibold text-[#4f635d]">Your sign-in details and workspace identity.</p>
